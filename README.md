...
Replication need not be limited to a 1-dimensional grid, let alone a discrete structure at all. Replication could occur in a more physically-realistic environment, where life, death, and replication are all intertwined physically, rather than being separated into grid-like elements. Replication could occur in a more natural computational structure, such as a file system, or in computer memory (like Core Wars).


##### Foragers
The introduction of metabolism and survival into the 
