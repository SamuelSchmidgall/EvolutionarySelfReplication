...
import evo_gym
from evo_gym.wrappers import GrayScaleObservation
from evo_gym.wrappers import AtariPreprocessing
...
def test_gray_scale_observation(env_id, keep_dim):
    gray_env = AtariPreprocessing(evo_gym.make(env_id), screen_size=84, grayscale_obs=True)
    rgb_env = AtariPreprocessing(evo_gym.make(env_id), screen_size=84, grayscale_obs=False)
